...
def generate_catalog(output_path: Path, config: SizeConfig) -> None:
    ...
    (output_path / "__init__.py").write_text('"""Generated Storytime catalog."""\n')
...
def seed(
    ...
    """Generate an example Storytime catalog for learning and prototyping.

    Creates a fully functional catalog with components, stories, and themed layout.
    The generated catalog can be used with 'storytime serve' and 'storytime build'.
