...
def validate_no_collisions(static_folders: list[StaticFolder]) -> None:
    ...
    (storytime_static/ vs static/), collisions should never happen in practice.
    ...
    Example:
        ...
        >>> from storytime.static_assets.models import StaticFolder
        >>> folders = [
        ...     StaticFolder(Path("a/static"), "storytime", Path("a")),
    ...
    Note:
        - Collisions are virtually impossible due to:
          ...
          2. Source type disambiguation (storytime_static/ vs static/)
