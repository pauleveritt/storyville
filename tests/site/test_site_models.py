...
def test_site_post_update() -> None:
...
def test_site_post_update_title_fallback() -> None:
    """Test Site.post_update uses package_path when title is None."""
    site = Site()  # No title provided

    tree_node = MagicMock()
    tree_node.name = "root"
    tree_node.this_package_location = "examples.minimal"
...
def test_site_has_no_parent() -> None:
