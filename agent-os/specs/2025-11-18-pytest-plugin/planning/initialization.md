...
### Relevant Files
- `/src/storyville/story/models.py` - Story model with assertions field
...
## Spec Path
`/Users/pauleveritt/projects/t-strings/storyville/agent-os/specs/2025-11-18-pytest-plugin`
