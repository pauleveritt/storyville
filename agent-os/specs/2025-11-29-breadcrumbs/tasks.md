...
- [x] 2.0 Populate resource_path during catalog construction
...
- [x] 3.0 Rename current_path to resource_path across all components
...
- [x] 4.0 Update all view signatures to accept and use resource_path
...
- [x] 5.0 Update build.py to pass resource_path to views
  ...
  - [x] 5.5 Update NavigationTree calls in build.py
    ...
    - Change: `NavigationTree(sections=catalog.items, resource_path="")`
...
- [x] 6.0 Remove Parent links from all view templates
...
- [x] 7.0 Convert breadcrumb links to relative paths
...
- [x] 8.0 Review existing tests and verify breadcrumbs functionality
