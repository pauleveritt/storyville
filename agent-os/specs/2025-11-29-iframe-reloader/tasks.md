...
- [ ] 1.0 Implement iframe reload logic in ws.js
  - [ ] 1.1 Write 2-8 focused tests for iframe reload functionality
  ...
  - [ ] 1.2 Add Mode C detection function
  ...
  - [ ] 1.3 Add iframe reload function
  ...
  - [ ] 1.4 Update scheduleReload() for conditional behavior
  ...
  - [ ] 1.5 Update RELOAD_DEBOUNCE_DELAY constant
    - Change from 300ms to 100ms as specified in requirements
    - Update constant: `const RELOAD_DEBOUNCE_DELAY = 100; // 100ms`
  - [ ] 1.6 Ensure core reload tests pass
...
- [ ] 2.0 Implement scroll position preservation
  - [ ] 2.1 Write 2-8 focused tests for scroll preservation
  ...
  - [ ] 2.2 Add scroll capture function
  ...
  - [ ] 2.3 Add scroll restore function
  ...
  - [ ] 2.4 Update reloadIframe() to preserve scroll
    - Capture scroll position before reload: `const scrollState = captureIframeScroll(iframe);`
  ...
  - [ ] 2.5 Ensure scroll preservation tests pass
...
- [ ] 3.0 Implement visual feedback during reload
  - [ ] 3.1 Write 2-8 focused tests for visual feedback
    ...
    - Location: Add to existing `/Users/pauleveritt/projects/pauleveritt/storytime/tests/static/ws_test.html`
  - [ ] 3.2 Add CSS for iframe reload effect
  ...
  - [ ] 3.3 Add visual effect functions
  ...
  - [ ] 3.4 Update reloadIframe() to apply visual effect
  ...
  - [ ] 3.5 Ensure visual feedback tests pass
...
- [ ] 4.0 Implement error handling and review test gaps
  ...
  - [ ] 4.2 Add iframe error fallback handler
  ...
  - [ ] 4.3 Analyze test coverage gaps for iframe reload feature
