...
Implement intelligent change detection for hot reload that tracks currently-viewed pages, filters changes by story
relevance, and uses either iframe reload or DOM morphing based on what changed.
...
- [x] 2.0 Complete change detection classification system
