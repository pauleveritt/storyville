...
This feature adds automatic browser refresh capability using WebSocket-based file watching. The implementation uses a dual-watcher architecture: INPUT watcher monitors source files and triggers rebuilds, OUTPUT watcher monitors build output and triggers browser reloads.
...
- [ ] 1.0 Complete WebSocket client JavaScript
  - [ ] 1.1 Write 2-8 focused tests for client behavior
  ...
  - [ ] 1.2 Create inline JavaScript for WebSocket client
...
- [ ] 4.0 Complete file watcher implementation
  - [ ] 4.1 Write 2-8 focused integration tests for watchers
    ...
    - Add pytest marker to `pyproject.toml`: `markers = ["slow: marks tests as slow (deselect with '-m \"not slow\"')"]`
